  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 space-y-4">
        ...
        {user.artistSlugs.length > 0 ? (
          <div className="rounded-lg border p-4">
            <h2 className="text-sm font-semibold uppercase text-neutral-500">Profil artiste</h2>
            <p className="mt-2 text-sm text-neutral-700">
              Modifie ta biographie, ton portrait, ta couverture et tes liens publics.
            </p>
            <Link
              href="/dashboard/profile"
              className="mt-3 inline-flex items-center justify-center rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50"
            >
              Modifier mon profil
            </Link>
          </div>
