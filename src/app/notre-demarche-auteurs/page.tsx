      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-14 sm:py-18">
        <header className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3 text-sm font-medium text-neutral-800">
            {['Droits d’auteur conservés', 'Commission claire', 'Contrat lisible'].map((item) => (
              <span
                key={item}
                className="rounded-full bg-neutral-900 text-white px-4 py-1.5 shadow-sm ring-4 ring-neutral-900/5"
              >
                {item}
              </span>
            ))}
        ...
        <section className="mt-12 grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
